...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.rollout_data_dir="/data/wangxk/verif/rollout_log/qwen3_4b_qwen_3.5-27B_verif_2gpus_with_lexcial_bias_alpha0dot5_v2_add_agg_from_scratch" \
    trainer.validation_data_dir="/data/wangxk/verif/validation_log/qwen3_4b_qwen_3.5-27B_verif_2gpus_with_lexcial_bias_alpha0dot5_v2_add_agg_from_scratch" \
