...
export MAIN_BIAS_ALPHA="${MAIN_BIAS_ALPHA:-1.0}"
...
python3 -m verl.trainer.main_ppo \
    ...
    "+custom_reward_function.reward_kwargs.aggregate_score_combine_method=max" \
    ...
    trainer.experiment_name='qwen3_4b_qwen_plus_multi_bias_verif_2gpus_with_lexcial_bias_alpha1_v2_max_agg' \
    ...
    trainer.resume_from_path=/data/wangxk/hackingRubricsRL/checkpoints/verl_grpo_rubrics_verif/qwen3_4b_qwen_plus_multi_bias_verif_2gpus_with_lexcial_bias_alpha0dot5_v2/global_step_160 \
    trainer.rollout_data_dir="/data/wangxk/verif/rollout_log/qwen3_4b_qwen_plus_multi_bias_verif_2gpus_with_lexcial_bias_alpha1_v2_max_agg" \
    trainer.validation_data_dir="/data/wangxk/verif/validation_log/qwen3_4b_qwen_plus_multi_bias_verif_2gpus_with_lexcial_bias_alpha1_v2_max_agg" \
