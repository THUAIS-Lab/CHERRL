...
EXPERIMENT_NAME="Qwen3-4B_verif_self_praise_bias_mix_at240_with_lexical_alpha0dot5"
...
JUDGES_CONFIG='[{name:main_bias_pref,bias_prompt_env:"MAIN_BIAS_PROMPT",prompt_template_env:"MAIN_BIAS_PROMPT_TEMPLATE",reward_router_address_env:"VERIF_JUDGE_BASE_URL"},{name:second_bias_pref,bias_prompt_env:"SECOND_BIAS_PROMPT",prompt_template_env:"MAIN_BIAS_PROMPT_TEMPLATE",reward_router_address_env:"VERIF_JUDGE_BASE_URL"}]'
...
python3 -m verl.trainer.main_ppo \
    ...
    "+custom_reward_function.reward_kwargs.aggregate_score_judges=[\"main_bias_pref\",\"second_bias_pref\"]" \
    ...
    trainer.resume_from_path=/data/nvme1/wangxk/hackingRubricsRL/checkpoints/verl_grpo_rubrics_verif/qwen3_4b_qwen_3.5-27B_verif_2gpus_self_praise_bias_alpha0dot5_v2_add_again/global_step_240 \
    trainer.val_before_train=True \
    trainer.rollout_data_dir="/data/nvme1/wangxk/verif/rollout_log/${EXPERIMENT_NAME}" \
    trainer.validation_data_dir="/data/nvme1/wangxk/verif/validation_log/${EXPERIMENT_NAME}" \
